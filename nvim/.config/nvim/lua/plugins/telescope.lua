...
nnoremap('<leader>fp', function() require('telescope.builtin').pickers() end)
nnoremap('<leader>f<leader>', function() require('telescope.builtin').builtin() end)
nnoremap('<C-p>', function() require('telescope.builtin').oldfiles() end)
